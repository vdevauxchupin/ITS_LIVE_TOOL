...
# %% auto 0
__all__ = ['var_ls', 'baltoro', 'point_to_gdf', 'remove_empty_timesteps', 'GlacierCenterline', 'Glacier_lw', 'Glacier_hw',
...
class Glacier_lw():
    ...
    def __init__(self, name, rgi_id):
        ...
        self.utm_zone = self.outline.estimate_utm_crs()
...
baltoro = GlacierLight('baltoro', gpdf[0]['RGIID'].iloc[0])
